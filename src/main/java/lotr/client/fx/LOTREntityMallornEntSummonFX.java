...
public class LOTREntityMallornEntSummonFX extends EntityDiggingFX {
	...
	private void updateArcPos() {
		...
		double[] posA = new double[] { summoner.posX, summoner.boundingBox.minY + summoner.height * 0.7, summoner.posZ };
		double[] posC = new double[] { summoned.posX, summoned.boundingBox.minY + summoned.height * 0.7, summoned.posZ };
