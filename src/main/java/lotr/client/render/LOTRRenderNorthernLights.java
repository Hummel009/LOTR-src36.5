...
public class LOTRRenderNorthernLights {
	...
	private static Color[] generateColorSet() {
		float h1 = MathHelper.randomFloatClamp(rand, 0.21f, 0.44f);
		float h2 = MathHelper.randomFloatClamp(rand, 0.21f, 0.44f);
		float h3 = MathHelper.randomFloatClamp(rand, 0.21f, 0.44f);
		if (rand.nextInt(3) == 0) {
