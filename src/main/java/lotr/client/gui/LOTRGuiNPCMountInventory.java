...
public class LOTRGuiNPCMountInventory extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		fontRendererObj.drawString(theMountInv.hasCustomInventoryName() ? theMountInv.getInventoryName() : I18n.format(theMountInv.getInventoryName(), new Object[0]), 8, 6, 4210752);
		fontRendererObj.drawString(thePlayerInv.hasCustomInventoryName() ? thePlayerInv.getInventoryName() : I18n.format(thePlayerInv.getInventoryName(), new Object[0]), 8, ySize - 96 + 2, 4210752);
	}
