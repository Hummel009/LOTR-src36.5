...
public class LOTRGuiSquadronItem extends LOTRGuiScreenBase {
	...
	public void initGui() {
		...
		buttonDone = new GuiButton(1, guiLeft + xSize / 2 - 40, guiTop + 85, 80, 20, StatCollector.translateToLocal("lotr.gui.squadronItem.done"));
	...
	public void drawScreen(int i, int j, float f) {
		...
		noSquadron = StringUtils.isNullOrEmpty(squadronNameField.getText()) && !squadronNameField.isFocused();
		if (noSquadron) {
