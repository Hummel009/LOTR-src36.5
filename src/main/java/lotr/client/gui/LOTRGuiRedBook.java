...
public class LOTRGuiRedBook extends LOTRGuiScreenBase {
	...
	private void setupScrollBar(int i, int j) {
		...
		mouseInScrollBar = i1 >= scrollBarX + scrollBarActiveXBorder && i1 < scrollBarX + scrollBarWidth - scrollBarActiveXBorder * 2 && j1 >= scrollBarY + scrollBarActiveYOffset && j1 < scrollBarY + scrollBarActiveYOffset + scrollBarActiveHeight;
