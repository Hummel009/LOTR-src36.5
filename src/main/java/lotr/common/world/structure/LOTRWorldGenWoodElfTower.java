	...
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		for (int l = -1; l < sections; ++l) {
				...
				for (i12 = i - radius; i12 <= i + radius; ++i12) {
					for (k13 = k - radius; k13 <= k + radius; ++k13) {
						...
						if (distSq >= wallThresholdMin) {
							setBlockAndNotifyAdequately(world, i12, j14, k13, LOTRMod.brick3, 5);
							if (l == sections - 1 && j14 == sectionBase + sectionHeight) {
								setBlockAndNotifyAdequately(world, i12, j14 + 1, k13, LOTRMod.brick3, 5);
								setBlockAndNotifyAdequately(world, i12, j14 + 2, k13, LOTRMod.slabSingle6, 2);
							}
						} else if (j14 == sectionBase + sectionHeight && (Math.abs(i2) > 2 || Math.abs(k2) > 2)) {
							setBlockAndNotifyAdequately(world, i12, j14, k13, LOTRMod.planks2, 13);
						} else {
							setBlockAndNotifyAdequately(world, i12, j14, k13, Blocks.air, 0);
						}
						setGrassToDirt(world, i12, j14 - 1, k13);
					}
				}
			...
			for (int l1 = 0; l1 < 2; ++l1) {
				...
				for (i1 = 0; i1 <= 1; ++i1) {
					for (k1 = 0; k1 <= 1; ++k1) {
						setBlockAndNotifyAdequately(world, i + 1 + i1, stairBase + 1, k + 1 + k1, LOTRMod.slabSingle6, 10);
						setBlockAndNotifyAdequately(world, i + 1 + i1, stairBase + 2, k - 2 + k1, LOTRMod.slabSingle6, 10);
						setBlockAndNotifyAdequately(world, i - 2 + i1, stairBase + 3, k - 2 + k1, LOTRMod.slabSingle6, 10);
						setBlockAndNotifyAdequately(world, i - 2 + i1, stairBase + 4, k + 1 + k1, LOTRMod.slabSingle6, 10);
					}
				}
			...
			if (l > 0) {
				...
				for (j14 = sectionBase + 1; j14 <= sectionBase + 4; ++j14) {
					...
					for (k12 = k - 1; k12 <= k + 1; ++k12) {
						setBlockAndNotifyAdequately(world, i - 6, j14, k12, Blocks.air, 0);
						setBlockAndNotifyAdequately(world, i + 6, j14, k12, Blocks.air, 0);
					}
				}
		...
		for (j1 = j - sectionHeight - 6; j1 <= j - sectionHeight - 1; ++j1) {
			...
			if (j1 == j - sectionHeight - 6 || j1 == j - sectionHeight - 1) {
				...
				for (k13 = k - 2; k13 <= k + 2; ++k13) {
					placeDungeonBlock(world, random, i - 4, j1, k13);
				}
				for (k13 = k - 3; k13 <= k + 3; ++k13) {
					placeDungeonBlock(world, random, i - 3, j1, k13);
				}
				for (k13 = k - 5; k13 <= k + 5; ++k13) {
					placeDungeonBlock(world, random, i - 2, j1, k13);
					placeDungeonBlock(world, random, i - 1, j1, k13);
					placeDungeonBlock(world, random, i, j1, k13);
				}
				for (k13 = k - 3; k13 <= k + 3; ++k13) {
					placeDungeonBlock(world, random, i + 1, j1, k13);
				}
			...
			for (k13 = k - 2; k13 <= k + 2; ++k13) {
				setBlockAndNotifyAdequately(world, i - 4, j1, k13, Blocks.air, 0);
			}
			for (k13 = k - 3; k13 <= k + 3; ++k13) {
				setBlockAndNotifyAdequately(world, i - 3, j1, k13, Blocks.air, 0);
			}
			for (k13 = k - 5; k13 <= k + 5; ++k13) {
				setBlockAndNotifyAdequately(world, i - 2, j1, k13, Blocks.air, 0);
				setBlockAndNotifyAdequately(world, i - 1, j1, k13, Blocks.air, 0);
				setBlockAndNotifyAdequately(world, i, j1, k13, Blocks.air, 0);
			}
			for (k13 = k - 3; k13 <= k + 3; ++k13) {
				setBlockAndNotifyAdequately(world, i + 1, j1, k13, Blocks.air, 0);
			}
		...
		for (k12 = k - 1; k12 <= k + 1; ++k12) {
			placeDungeonBlock(world, random, i + 3, j - sectionHeight - 2, k12);
			placeDungeonBlock(world, random, i + 4, j - sectionHeight - 2, k12);
		}
		for (j1 = j - sectionHeight - 5; j1 <= j - sectionHeight - 3; ++j1) {
			...
			for (k13 = k - 1; k13 <= k + 1; ++k13) {
				setBlockAndNotifyAdequately(world, i + 3, j1, k13, LOTRMod.woodElfBars, 0);
			}
		}
		...
		setBlockAndNotifyAdequately(world, i - 5, j - sectionHeight + 1, k, LOTRMod.trapdoorGreenOak, 3);
		switch (rotation) {
		case 0: {
			int j16;
			k1 = k - radius;
			for (i12 = i - 1; i12 <= i + 1; ++i12) {
				for (j16 = j + 1; j16 <= j + 3; ++j16) {
					setBlockAndNotifyAdequately(world, i12, j16, k1, LOTRMod.gateWoodElven, 2);
				}
			}
			placeWallBanner(world, i, j + 6, k1, 2, LOTRItemBanner.BannerType.WOOD_ELF);
			break;
		}
		case 1: {
			int j16;
			...
			for (k1 = k - 1; k1 <= k + 1; ++k1) {
				for (j16 = j + 1; j16 <= j + 3; ++j16) {
					setBlockAndNotifyAdequately(world, i12, j16, k1, LOTRMod.gateWoodElven, 5);
				}
			}
		...
		case 2: {
			...
			for (i12 = i - 1; i12 <= i + 1; ++i12) {
				for (j16 = j + 1; j16 <= j + 3; ++j16) {
					setBlockAndNotifyAdequately(world, i12, j16, k1, LOTRMod.gateWoodElven, 3);
				}
			}
			placeWallBanner(world, i, j + 6, k1, 0, LOTRItemBanner.BannerType.WOOD_ELF);
			break;
		}
		case 3: {
			int j16;
			...
			for (k1 = k - 1; k1 <= k + 1; ++k1) {
				for (j16 = j + 1; j16 <= j + 3; ++j16) {
					setBlockAndNotifyAdequately(world, i12, j16, k1, LOTRMod.gateWoodElven, 4);
				}
			}
