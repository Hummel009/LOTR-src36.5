	...
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		if (restrictions) {
			for (int i12 = i - 7; i12 <= i + 7; ++i12) {
				for (k1 = k - 7; k1 <= k + 7; ++k1) {
					...
					if (block == Blocks.grass || block == Blocks.stone || block == Blocks.dirt || block.isWood(world, i12, j1, k1) || block.isLeaves(world, i12, j1, k1)) {
						continue;
					}
					return false;
				}
		...
		for (k12 = k - 2; k12 <= k + 2; ++k12) {
			for (j12 = j; !LOTRMod.isOpaque(world, i - 6, j12, k12) && j12 >= 0; --j12) {
				setBlockAndNotifyAdequately(world, i - 6, j12, k12, LOTRMod.brick2, 0);
				setGrassToDirt(world, i - 6, j12 - 1, k12);
			}
			for (j12 = j; !LOTRMod.isOpaque(world, i + 6, j12, k12) && j12 >= 0; --j12) {
				setBlockAndNotifyAdequately(world, i + 6, j12, k12, LOTRMod.brick2, 0);
				setGrassToDirt(world, i + 6, j12 - 1, k12);
		...
		for (k12 = k - 4; k12 <= k + 4; ++k12) {
			for (j12 = j; !LOTRMod.isOpaque(world, i - 5, j12, k12) && j12 >= 0; --j12) {
				setBlockAndNotifyAdequately(world, i - 5, j12, k12, LOTRMod.brick2, 0);
				setGrassToDirt(world, i - 5, j12 - 1, k12);
			}
			for (j12 = j; !LOTRMod.isOpaque(world, i + 5, j12, k12) && j12 >= 0; --j12) {
				setBlockAndNotifyAdequately(world, i + 5, j12, k12, LOTRMod.brick2, 0);
				setGrassToDirt(world, i + 5, j12 - 1, k12);
		...
		for (k12 = k - 5; k12 <= k + 5; ++k12) {
			for (i1 = i - 4; i1 <= i - 3; ++i1) {
				for (j1 = j; !LOTRMod.isOpaque(world, i1, j1, k12) && j1 >= 0; --j1) {
					setBlockAndNotifyAdequately(world, i1, j1, k12, LOTRMod.brick2, 0);
