	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (k12 = -12; k12 <= 12; ++k12) {
				...
				for (j14 = 0; (j14 >= 0 || !isOpaque(world, i15, j14, k12)) && getY(j14) >= 0; --j14) {
					if (i2 == 12 && (k2 == 12 || k2 == 9 || k2 == 2) || k2 == 12 && (i2 == 12 || i2 == 9 || i2 == 2)) {
						setBlockAndMetadata(world, i15, j14, k12, woodBeam2Block, woodBeam2Meta);
					} else if (i2 > 9 || k2 > 9) {
						...
						if (randomGround == 0) {
							...
							setBlockAndMetadata(world, i15, j14, k12, LOTRMod.dirtPath, 0);
						}
						if (random.nextInt(3) == 0) {
							setBlockAndMetadata(world, i15, j14 + 1, k12, LOTRMod.thatchFloor, 0);
						}
					} else {
		...
		for (i15 = -12; i15 <= 12; ++i15) {
			for (k12 = -12; k12 <= 12; ++k12) {
				...
				if ((i2 == 9 || i2 == 12) && (k2 == 9 || k2 == 12)) {
					for (j15 = 1; j15 <= 8; ++j15) {
						setBlockAndMetadata(world, i15, j15, k12, woodBeam2Block, woodBeam2Meta);
					}
					continue;
				}
				...
				if (k12 == -9) {
					setBlockAndMetadata(world, i15, 4 + yBoost, k12, plank2StairBlock, 7);
					continue;
				}
				if (k12 == 9) {
					setBlockAndMetadata(world, i15, 4 + yBoost, k12, plank2StairBlock, 6);
					continue;
				}
				if (i15 == -9) {
					setBlockAndMetadata(world, i15, 4 + yBoost, k12, plank2StairBlock, 4);
					continue;
				}
				if (i15 != 9) {
					continue;
				}
				setBlockAndMetadata(world, i15, 4 + yBoost, k12, plank2StairBlock, 5);
			}
		}
		...
		for (k1 = -12; k1 <= 12; ++k1) {
			...
			if (k24 >= 10 && k24 <= 11 || k24 >= 3 && k24 <= 8) {
				setBlockAndMetadata(world, -12, 1, k1, plank2StairBlock, 1);
				for (j12 = 2; j12 <= 3; ++j12) {
					setAir(world, -12, j12, k1);
				}
				setBlockAndMetadata(world, -12, 4, k1, plank2StairBlock, 5);
				setBlockAndMetadata(world, 12, 1, k1, plank2StairBlock, 0);
				for (j12 = 2; j12 <= 3; ++j12) {
					setAir(world, 12, j12, k1);
				}
				setBlockAndMetadata(world, 12, 4, k1, plank2StairBlock, 4);
			}
			if (k24 != 12 || k1 <= 0) {
				continue;
			}
			for (i12 = -1; i12 <= 1; ++i12) {
				setBlockAndMetadata(world, i12, 1, k1, plank2Block, plank2Meta);
				setBlockAndMetadata(world, i12, 4, k1, plank2Block, plank2Meta);
				setBlockAndMetadata(world, i12, 5, k1, woodBeam2Block, woodBeam2Meta | 4);
			...
			setBlockAndMetadata(world, 2, 7, k1, plankSlabBlock, plankSlabMeta);
			setBlockAndMetadata(world, -1, 2, k1, plank2StairBlock, 0);
			setAir(world, 0, 2, k1);
			setBlockAndMetadata(world, 1, 2, k1, plank2StairBlock, 1);
			setBlockAndMetadata(world, -1, 3, k1, plank2StairBlock, 4);
			setAir(world, 0, 3, k1);
			setBlockAndMetadata(world, 1, 3, k1, plank2StairBlock, 5);
		}
		for (i14 = -12; i14 <= 12; ++i14) {
			int i23 = Math.abs(i14);
			if (i23 >= 10 && i23 <= 11 || i23 >= 3 && i23 <= 8) {
				setBlockAndMetadata(world, i14, 1, -12, plank2StairBlock, 2);
				for (j12 = 2; j12 <= 3; ++j12) {
					setAir(world, i14, j12, -12);
				}
				setBlockAndMetadata(world, i14, 4, -12, plank2StairBlock, 6);
				setBlockAndMetadata(world, i14, 1, 12, plank2StairBlock, 3);
				for (j12 = 2; j12 <= 3; ++j12) {
					setAir(world, i14, j12, 12);
				}
				setBlockAndMetadata(world, i14, 4, 12, plank2StairBlock, 7);
			}
			if (i23 != 12) {
				continue;
			}
			for (k13 = -1; k13 <= 1; ++k13) {
				...
				setBlockAndMetadata(world, i14, 5, k13, woodBeam2Block, woodBeam2Meta | 8);
			...
			setBlockAndMetadata(world, i14, 7, 2, plankSlabBlock, plankSlabMeta);
			setBlockAndMetadata(world, i14, 2, -1, plank2StairBlock, 3);
			setAir(world, i14, 2, 0);
			setBlockAndMetadata(world, i14, 2, 1, plank2StairBlock, 2);
			setBlockAndMetadata(world, i14, 3, -1, plank2StairBlock, 7);
			setAir(world, i14, 3, 0);
			setBlockAndMetadata(world, i14, 3, 1, plank2StairBlock, 6);
		}
		for (k1 = -11; k1 <= -10; ++k1) {
			setAir(world, -6, 5, k1);
		...
		for (j1 = 4; j1 <= 7; ++j1) {
			setBlockAndMetadata(world, -6, j1, -9, woodBeam2Block, woodBeam2Meta);
			setBlockAndMetadata(world, 6, j1, -9, woodBeam2Block, woodBeam2Meta);
		}
		...
		for (k1 = -12; k1 <= -10; ++k1) {
			for (j13 = 1; j13 <= 4; ++j13) {
				...
				setBlockAndMetadata(world, -2, j13, k1, woodBeam2Block, woodBeam2Meta);
				setBlockAndMetadata(world, 2, j13, k1, woodBeam2Block, woodBeam2Meta);
			}
			for (i1 = -1; i1 <= 1; ++i1) {
				setBlockAndMetadata(world, i1, 4, k1, woodBeam2Block, woodBeam2Meta | 4);
			}
		}
		for (j1 = 1; j1 <= 3; ++j1) {
			for (i1 = -1; i1 <= 1; ++i1) {
		...
		for (i14 = -1; i14 <= 1; ++i14) {
			setBlockAndMetadata(world, i14, 4, -12, plank2StairBlock, 6);
			setBlockAndMetadata(world, i14, 5, -12, woodBeam2Block, woodBeam2Meta | 4);
			setBlockAndMetadata(world, i14, 6, -12, woodBeam2Block, woodBeam2Meta | 4);
			setBlockAndMetadata(world, i14, 6, -11, plankSlabBlock, plankSlabMeta);
		}
		for (j1 = 6; j1 <= 8; ++j1) {
			setBlockAndMetadata(world, 0, j1, -12, woodBeam2Block, woodBeam2Meta);
		}
		...
		for (k1 = -13; k1 <= 9; ++k1) {
			...
			setBlockAndMetadata(world, -2, 0, k1, rockSlabDoubleBlock, rockSlabDoubleMeta);
			setBlockAndMetadata(world, 2, 0, k1, rockSlabDoubleBlock, rockSlabDoubleMeta);
		...
		for (j1 = 1; j1 <= 3; ++j1) {
			setBlockAndMetadata(world, -2, j1, 10, woodBeam2Block, woodBeam2Meta);
			setBlockAndMetadata(world, 2, j1, 10, woodBeam2Block, woodBeam2Meta);
		}
		...
		for (int k15 = -9; k15 <= -5; ++k15) {
			for (i1 = -9; i1 <= -5; ++i1) {
				setBlockAndMetadata(world, i1, 3, k15, plank2SlabBlock, plank2SlabMeta);
			}
		}
		...
		for (k12 = 5; k12 <= 9; ++k12) {
			for (i12 = -9; i12 <= -5; ++i12) {
				setBlockAndMetadata(world, i12, 3, k12, plank2SlabBlock, plank2SlabMeta);
			}
		}
		setBlockAndMetadata(world, -9, 3, 9, plank2Block, plank2Meta);
		for (j13 = 1; j13 <= 2; ++j13) {
		...
		for (k12 = 5; k12 <= 10; ++k12) {
			for (i12 = 5; i12 <= 10; ++i12) {
				setBlockAndMetadata(world, i12, 0, k12, plank2Block, plank2Meta);
				setAir(world, i12, 1, k12);
				setAir(world, i12, 2, k12);
				setBlockAndMetadata(world, i12, 3, k12, plank2Block, plank2Meta);
			}
		}
		for (k12 = 4; k12 <= 9; ++k12) {
		...
		for (i1 = 5; i1 <= 9; ++i1) {
			setBlockAndMetadata(world, i1, 3, 4, plank2StairBlock, 2);
		}
		for (k12 = 5; k12 <= 10; ++k12) {
		...
		for (i1 = 6; i1 <= 10; ++i1) {
			...
			for (k13 = 6; k13 <= 10; ++k13) {
				...
				setBlockAndMetadata(world, i1, 1, k13, LOTRMod.thatchFloor, 0);
			}
		}
