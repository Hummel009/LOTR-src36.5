...
public class LOTRWorldGenTauredainHouseLarge extends LOTRWorldGenTauredainHouse {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (j1 = 1; j1 <= 3; ++j1) {
			setBlockAndMetadata(world, -2, j1, -4, woodBlock, woodMeta);
			setBlockAndMetadata(world, 1, j1, -4, woodBlock, woodMeta);
			setBlockAndMetadata(world, -2, j1, 4, woodBlock, woodMeta);
			setBlockAndMetadata(world, 1, j1, 4, woodBlock, woodMeta);
			setBlockAndMetadata(world, -6, j1, 0, woodBlock, woodMeta);
			setBlockAndMetadata(world, 5, j1, 0, woodBlock, woodMeta);
		}
		...
		for (j1 = 5; j1 <= 9; ++j1) {
			setBlockAndMetadata(world, -4, j1, -2, woodBlock, woodMeta);
			setBlockAndMetadata(world, 3, j1, -2, woodBlock, woodMeta);
			setBlockAndMetadata(world, -4, j1, 2, woodBlock, woodMeta);
			setBlockAndMetadata(world, 3, j1, 2, woodBlock, woodMeta);
		}
