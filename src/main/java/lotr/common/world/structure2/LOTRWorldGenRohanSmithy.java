...
public class LOTRWorldGenRohanSmithy extends LOTRWorldGenRohanStructure {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (i1 = -4; i1 <= 4; ++i1) {
			...
			if (i2 == 2) {
				for (j13 = 1; j13 <= 2; ++j13) {
					setBlockAndMetadata(world, i1, j13, -3, logBlock, logMeta);
				}
				for (j13 = 3; j13 <= 4; ++j13) {
					setBlockAndMetadata(world, i1, j13, -3, fenceBlock, fenceMeta);
				}
			}
			if (i2 == 3) {
				for (j13 = 2; j13 <= 4; ++j13) {
					setBlockAndMetadata(world, i1, j13, -2, plankBlock, plankMeta);
				}
			}
			if (i2 == 4) {
				int[] j15 = new int[] { -2, 3 };
		...
		for (i1 = -3; i1 <= 3; ++i1) {
			...
			if (i2 <= 1) {
				for (j13 = 2; j13 <= 6; ++j13) {
					setBlockAndMetadata(world, i1, j13, 3, brickBlock, brickMeta);
				}
			}
			if (i2 == 2) {
		...
		for (j12 = 7; j12 <= 9; ++j12) {
			setBlockAndMetadata(world, 0, j12, 3, brickBlock, brickMeta);
		}
		...
		for (j12 = 3; j12 <= 4; ++j12) {
			setBlockAndMetadata(world, -1, j12, 2, brickWallBlock, brickWallMeta);
			setBlockAndMetadata(world, 1, j12, 2, brickWallBlock, brickWallMeta);
		}
		...
		for (j12 = 3; j12 <= 4; ++j12) {
			...
			placeWeaponRack(world, 3, j12, 2, 6, weapon);
		}
