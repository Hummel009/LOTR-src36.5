...
public class LOTRWorldGenElfHouse extends LOTRWorldGenStructureBase2 {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (usingPlayer != null) {
			...
			j1 = 0;
			k12 = 0;
			int height = treeGen.generateAndReturnHeight(world, random, getX(i12, k12), getY(j1), getZ(i12, k12), true);
		...
		if (restrictions) {
			for (int i13 = -8; i13 <= 8; ++i13) {
				for (j12 = -3; j12 <= 6; ++j12) {
					for (k14 = -8; k14 <= 8; ++k14) {
						if (Math.abs(i13) <= 2 && Math.abs(k14) <= 2 || isAir(world, i13, j12, k14)) {
							continue;
						}
						return false;
					}
			...
			for (int i14 = -2; i14 <= 2; ++i14) {
				for (k13 = -2; k13 <= 2; ++k13) {
					...
					while (!isOpaque(world, i14, j1, k13) && getY(j1) >= 0) {
						setBlockAndMetadata(world, i14, j1, k13, LOTRMod.wood, 1);
						--j1;
					}
				}
			}
		...
		for (i1 = -7; i1 <= 7; ++i1) {
			for (j12 = 1; j12 <= 4; ++j12) {
				for (k14 = -7; k14 <= 7; ++k14) {
					setBlockAndMetadata(world, i1, j12, k14, Blocks.air, 0);
				}
			}
		}
		for (i1 = -2; i1 <= 2; ++i1) {
			for (j12 = -1; j12 <= 5; ++j12) {
				for (k14 = -2; k14 <= 2; ++k14) {
					setBlockAndMetadata(world, i1, j12, k14, LOTRMod.wood, 1);
					if (j12 < 1 || j12 > 2 || Math.abs(i1) != 2 || Math.abs(k14) != 2) {
						continue;
					}
					setBlockAndMetadata(world, i1, j12, k14, LOTRMod.fence, 1);
				}
			}
		}
		for (i1 = -6; i1 <= 6; ++i1) {
			for (k13 = -6; k13 <= 6; ++k13) {
				if (Math.abs(i1) <= 2 && Math.abs(k13) <= 2 || Math.abs(i1) == 6 || Math.abs(k13) == 6) {
					continue;
				}
				setBlockAndMetadata(world, i1, 0, k13, LOTRMod.planks, 1);
			}
		}
		for (i1 = -5; i1 <= 5; ++i1) {
		...
		for (i1 = -6; i1 <= 6; ++i1) {
			for (k13 = -6; k13 <= 6; ++k13) {
				if (restrictions && i1 >= -2 && i1 <= 2 && k13 >= -2 && k13 <= 2 || (i1 == -6 || i1 == 6) && (k13 == -6 || k13 == 6)) {
					continue;
				}
				setBlockAndMetadata(world, i1, 5, k13, LOTRMod.planks, 1);
			}
		}
		for (i1 = -3; i1 <= 3; ++i1) {
		...
		for (i1 = -5; i1 <= 5; ++i1) {
			for (k13 = -5; k13 <= 5; ++k13) {
				if (restrictions && i1 >= -2 && i1 <= 2 && k13 >= -2 && k13 <= 2 || (i1 == -5 || i1 == 5) && (k13 == -5 || k13 == 5)) {
					continue;
				}
				setBlockAndMetadata(world, i1, 6, k13, LOTRMod.planks, 1);
			}
		}
		for (i1 = -2; i1 <= 2; ++i1) {
		...
		for (int bough = 0; bough <= 2; ++bough) {
			...
			for (int i2 = -i15; i2 <= i15; ++i2) {
				for (int k2 = -k12; k2 <= k12; ++k2) {
					setBlockAndMetadata(world, i2, j12, k2, LOTRMod.wood, 13);
					setBlockAndMetadata(world, k2, j12, i2, LOTRMod.wood, 13);
				}
			}
		}
		Block ladder = random.nextBoolean() ? LOTRMod.hithlainLadder : LOTRMod.mallornLadder;
		for (j12 = 3; j12 >= -3 || !isOpaque(world, 0, j12, -3) && getY(j12) >= 0; --j12) {
			setBlockAndMetadata(world, 0, j12, -3, ladder, 2);
		}
