	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (i12 = -10; i12 <= 10; ++i12) {
			for (k12 = -10; k12 <= 10; ++k12) {
				...
				k2 = Math.abs(k12);
				if (i2 >= 8 || k2 >= 8) {
					setBlockAndMetadata(world, i12, 0, k12, brickBlock, brickMeta);
					if (k12 < 0 && i12 == 0) {
						setBlockAndMetadata(world, i12, 0, k12, LOTRMod.brick4, 4);
					}
				...
				if (i2 <= 1 && k12 <= 0) {
					...
					if (step == 0) {
						setBlockAndMetadata(world, -1, step, k12, brickBlock, brickMeta);
						setBlockAndMetadata(world, 0, step, k12, LOTRMod.brick4, 4);
						setBlockAndMetadata(world, 1, step, k12, brickBlock, brickMeta);
						continue;
					}
					if (step > 4) {
					...
					setBlockAndMetadata(world, -1, step, k12, brickStairBlock, 2);
					setBlockAndMetadata(world, 0, step, k12, LOTRMod.stairsTauredainBrickObsidian, 2);
					setBlockAndMetadata(world, 1, step, k12, brickStairBlock, 2);
					continue;
				}
				if ((i2 != 7 || k12 % 2 != 0) && (k2 != 7 || i12 % 2 != 0)) {
					continue;
				}
				setBlockAndMetadata(world, i12, 1, k12, brickWallBlock, brickWallMeta);
				placeTauredainTorch(world, i12, 2, k12);
			}
		}
		...
		for (k1 = -3; k1 <= 3; ++k1) {
			setBlockAndMetadata(world, -7, 5, k1, brickWallBlock, brickWallMeta);
			setBlockAndMetadata(world, 7, 5, k1, brickWallBlock, brickWallMeta);
		}
		for (i1 = -6; i1 <= -5; ++i1) {
		...
		for (k1 = 5; k1 <= 6; ++k1) {
			setBlockAndMetadata(world, -3, 5, k1, brickWallBlock, brickWallMeta);
			setBlockAndMetadata(world, 3, 5, k1, brickWallBlock, brickWallMeta);
		}
		for (i1 = -2; i1 <= 2; ++i1) {
			for (k12 = -2; k12 <= 2; ++k12) {
				...
				if (i2 == 2 && k2 == 2) {
					setBlockAndMetadata(world, i1, 10, k12, brickSlabBlock, brickSlabMeta);
				} else {
					setBlockAndMetadata(world, i1, 10, k12, brickBlock, brickMeta);
				}
				if (i2 == 1 && k2 == 1) {
					for (j1 = 11; j1 <= 12; ++j1) {
						setBlockAndMetadata(world, i1, j1, k12, brickWallBlock, brickWallMeta);
					}
				}
				if (i2 == 0 && k2 == 0) {
					setBlockAndMetadata(world, i1, 10, k12, LOTRMod.hearth, 0);
					setBlockAndMetadata(world, i1, 11, k12, Blocks.fire, 0);
				}
				if (i2 > 1 || k2 > 1) {
					continue;
				}
				setBlockAndMetadata(world, i1, 13, k12, LOTRMod.brick4, 3);
				if (k12 == -1) {
					setBlockAndMetadata(world, i1, 14, k12, LOTRMod.stairsTauredainBrickGold, 2);
					continue;
				}
				if (k12 == 1) {
					setBlockAndMetadata(world, i1, 14, k12, LOTRMod.stairsTauredainBrickGold, 3);
					continue;
				}
				if (i1 == -1) {
					setBlockAndMetadata(world, i1, 14, k12, LOTRMod.stairsTauredainBrickGold, 1);
					continue;
				}
				if (i1 == 1) {
					setBlockAndMetadata(world, i1, 14, k12, LOTRMod.stairsTauredainBrickGold, 0);
					continue;
				}
				setBlockAndMetadata(world, i1, 14, k12, LOTRMod.brick4, 3);
				setBlockAndMetadata(world, i1, 15, k12, LOTRMod.wall4, 3);
				placeTauredainTorch(world, i1, 16, k12);
			}
		}
