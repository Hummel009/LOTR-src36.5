	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (restrictions) {
			for (int i12 = -10; i12 <= 3; ++i12) {
				for (int k122 = 0; k122 <= 10; ++k122) {
					...
					Block block = getBlock(world, i12, j1, k122);
		...
		for (int i12 = -10; i12 <= 3; ++i12) {
			for (k12 = 0; k12 <= 10; ++k12) {
				...
				garden = i12 >= -10 && i12 <= -3 && k12 >= 0 && k12 <= 3;
				if (garden) {
					...
					plantFlower(world, random, i12, 1, k12);
					continue;
				}
				if (beam != 0) {
					for (int j122 = 1; j122 <= 8; ++j122) {
						setBlockAndMetadata(world, i12, j122, k12, woodBeamBlock, woodBeamMeta);
					}
				...
				if (wall) {
					...
					setBlockAndMetadata(world, i12, 1, k12, wallBlock, wallMeta);
					setBlockAndMetadata(world, i12, 2, k12, brickBlock, brickMeta);
					setBlockAndMetadata(world, i12, 3, k12, brickBlock, brickMeta);
					setBlockAndMetadata(world, i12, 5, k12, wallBlock, wallMeta);
					setBlockAndMetadata(world, i12, 6, k12, brickBlock, brickMeta);
					setBlockAndMetadata(world, i12, 7, k12, brickBlock, brickMeta);
					if (i12 == -10 || i12 == -2 || i12 == 3) {
						setBlockAndMetadata(world, i12, 4, k12, woodBeamBlock, woodBeamMeta | 8);
						setBlockAndMetadata(world, i12, 8, k12, woodBeamBlock, woodBeamMeta | 8);
						continue;
					}
					setBlockAndMetadata(world, i12, 4, k12, woodBeamBlock, woodBeamMeta | 4);
					setBlockAndMetadata(world, i12, 8, k12, woodBeamBlock, woodBeamMeta | 4);
					continue;
				}
				for (j12 = 0; (j12 >= 0 || !isOpaque(world, i12, j12, k12)) && getY(j12) >= 0; --j12) {
					setBlockAndMetadata(world, i12, j12, k12, floorBlock, floorMeta);
					setGrassToDirt(world, i12, j12 - 1, k12);
				}
				if (i12 >= 0 && i12 <= 1 && k12 >= 2 && k12 <= 8 || i12 >= -8 && i12 <= -2 && k12 >= 6 && k12 <= 8) {
					setBlockAndMetadata(world, i12, 4, k12, plankSlabBlock, plankSlabMeta | 8);
					continue;
				}
				setBlockAndMetadata(world, i12, 4, k12, plankBlock, plankMeta);
			}
		}
		for (int j13 : new int[] { 2, 6 }) {
			setAir(world, 0, j13, 0);
			setAir(world, 1, j13, 0);
			setBlockAndMetadata(world, 0, j13 + 1, 0, brickStairBlock, 4);
			setBlockAndMetadata(world, 1, j13 + 1, 0, brickStairBlock, 5);
			for (int k13 : new int[] { 2, 7 }) {
				setAir(world, 3, j13, k13);
				setAir(world, 3, j13, k13 + 1);
				setBlockAndMetadata(world, 3, j13 + 1, k13, brickStairBlock, 7);
				setBlockAndMetadata(world, 3, j13 + 1, k13 + 1, brickStairBlock, 6);
			}
			for (int i13 : new int[] { -4, -7 }) {
				setAir(world, i13, j13, 10);
				setAir(world, i13 - 1, j13, 10);
				setBlockAndMetadata(world, i13, j13 + 1, 10, brickStairBlock, 5);
				setBlockAndMetadata(world, i13 - 1, j13 + 1, 10, brickStairBlock, 4);
			}
			setAir(world, -10, j13, 8);
			setAir(world, -10, j13, 7);
			setAir(world, -10, j13, 6);
			setBlockAndMetadata(world, -10, j13 + 1, 8, brickStairBlock, 6);
			setBlockAndMetadata(world, -10, j13 + 1, 7, brickSlabBlock, brickSlabMeta | 8);
			setBlockAndMetadata(world, -10, j13 + 1, 6, brickStairBlock, 7);
			for (int i13 : new int[] { -8, -5 }) {
				setAir(world, i13, j13, 4);
				setAir(world, i13 + 1, j13, 4);
				setBlockAndMetadata(world, i13, j13 + 1, 4, brickStairBlock, 4);
				setBlockAndMetadata(world, i13 + 1, j13 + 1, 4, brickStairBlock, 5);
			}
			setAir(world, -2, j13, 2);
			setBlockAndMetadata(world, -2, j13 + 1, 2, brickSlabBlock, brickSlabMeta | 8);
		}
		setAir(world, 1, 6, 10);
		setAir(world, 0, 6, 10);
		...
		for (int j14 = 1; j14 <= 9; ++j14) {
			setBlockAndMetadata(world, 1, j14, 8, woodBeamBlock, woodBeamMeta);
		}
		...
		for (i1 = 0; i1 <= 1; ++i1) {
			for (k12 = 2; k12 <= 3; ++k12) {
				placePlate(world, random, i1, 6, k12, plateBlock, LOTRFoods.DORWINION);
			}
		}
		...
		for (k1 = -1; k1 <= 11; ++k1) {
			setBlockAndMetadata(world, 4, 8, k1, brickStairBlock, 4);
			if (IntMath.mod(k1, 2) != 1) {
				continue;
			}
			setBlockAndMetadata(world, 4, 9, k1, brickSlabBlock, brickSlabMeta);
		}
		for (i1 = -11; i1 <= 3; ++i1) {
		...
		for (k1 = 4; k1 <= 10; ++k1) {
			setBlockAndMetadata(world, -11, 8, k1, brickStairBlock, 5);
		}
		for (i1 = -11; i1 <= -3; ++i1) {
		...
		for (k1 = -1; k1 <= 2; ++k1) {
			setBlockAndMetadata(world, -3, 8, k1, brickStairBlock, 5);
			if (IntMath.mod(k1, 2) != 1) {
				continue;
			}
			setBlockAndMetadata(world, -3, 9, k1, brickSlabBlock, brickSlabMeta);
		}
		for (i1 = -9; i1 <= -1; ++i1) {
		...
		for (k1 = 1; k1 <= 9; ++k1) {
			if (k1 <= 5) {
				setBlockAndMetadata(world, -1, 9, k1, plankStairBlock, 4);
				setBlockAndMetadata(world, 0, 10, k1, plankStairBlock, 4);
			}
			setBlockAndMetadata(world, 1, 10, k1, plankStairBlock, 5);
			setBlockAndMetadata(world, 2, 9, k1, plankStairBlock, 5);
		}
