...
public class LOTRWorldGenHobbitHole extends LOTRWorldGenHobbitStructure {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (n = -16; n <= -13; n++) {
			setBlockAndMetadata(world, 4, 1, n, outFenceBlock, outFenceMeta);
			setBlockAndMetadata(world, -4, 1, n, outFenceBlock, outFenceMeta);
			setBlockAndMetadata(world, 0, 0, n, pathBlock, pathMeta);
		}
		int m;
		for (m = -1; m <= 1; m++) {
			setBlockAndMetadata(world, m, 0, -12, pathBlock, pathMeta);
			setBlockAndMetadata(world, m, 0, -11, pathBlock, pathMeta);
		}
		for (m = -3; m <= 3; m++) {
			setBlockAndMetadata(world, m, 1, -16, outFenceBlock, outFenceMeta);
		}
		...
		if (random.nextInt(3) == 0) {
			for (k1 = -14; k1 <= -13; k1++) {
				for (int i36 : new int[] { -2, 2 }) {
					setBlockAndMetadata(world, i36, 1, k1, hedgeBlock, hedgeMeta);
				}
			}
		}
		...
		if (gateFlip) {
			for (int i36 = 0; i36 <= 1; i36++) {
				setBlockAndMetadata(world, i36, 0, -10, floorBlock, floorMeta);
				for (int i37 = 1; i37 <= 2; i37++) {
					setAir(world, i36, i37, -11);
					setBlockAndMetadata(world, i36, i37, -10, gateBlock, 2);
				}
			}
			...
			setBlockAndMetadata(world, 0, 3, -12, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, 1, 3, -11, plank2StairBlock, 5);
			setBlockAndMetadata(world, 1, 3, -12, plank2SlabBlock, plank2SlabMeta | 0x8);
		...
		for (int i32 = -9; i32 <= 1; i32++) {
			...
			setBlockAndMetadata(world, 1, 0, i32, floorBlock, floorMeta);
			setBlockAndMetadata(world, 0, 0, i32, plankBlock, plankMeta);
			setBlockAndMetadata(world, -1, 0, i32, floorBlock, floorMeta);
			setBlockAndMetadata(world, 2, 1, i32, plank2StairBlock, 1);
			setBlockAndMetadata(world, -2, 1, i32, plank2StairBlock, 0);
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, 3, i36, i32, plank2Block, plank2Meta);
				setBlockAndMetadata(world, -3, i36, i32, plank2Block, plank2Meta);
			}
			setBlockAndMetadata(world, 2, 3, i32, plank2Block, plank2Meta);
			setBlockAndMetadata(world, -2, 3, i32, plank2Block, plank2Meta);
			setBlockAndMetadata(world, 1, 3, i32, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, -1, 3, i32, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, 0, 4, i32, plank2Block, plank2Meta);
		}
		for (int i36 : new int[] { -8, -4, 0 }) {
			setBlockAndMetadata(world, 0, 3, i36, chandelierBlock, chandelierMeta);
		}
		for (int i31 = 1; i31 <= 3; i31++) {
			for (int i36 = -2; i36 <= 2; i36++) {
				setBlockAndMetadata(world, i36, i31, 2, plank2Block, plank2Meta);
			}
		}
		...
		for (i30 = 3; i30 <= 9; i30++) {
			for (int i36 = -3; i36 <= 3; i36++) {
				...
				setBlockAndMetadata(world, i36, 4, i30, plank2Block, plank2Meta);
				setBlockAndMetadata(world, i36, 0, i30, plankBlock, plankMeta);
			}
		}
		setBlockAndMetadata(world, 0, 3, 6, chandelierBlock, chandelierMeta);
		for (i30 = 5; i30 <= 7; i30++) {
			for (int i36 = -1; i36 <= 1; i36++) {
				setBlockAndMetadata(world, i36, 1, i30, carpetBlock, carpetMeta);
			}
		}
		...
		for (i29 = -3; i29 <= 3; i29++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, i29, i36, 10, plank2Block, plank2Meta);
			}
		}
		for (i29 = -1; i29 <= 1; i29++) {
			...
			for (int i36 = 11; i36 <= 14; i36++) {
				setBlockAndMetadata(world, i29, 1, i36, Blocks.grass, 0);
				for (int i37 = 2; i37 <= 3; i37++) {
					setAir(world, i29, i37, i36);
				}
			}
			setBlockAndMetadata(world, i29, 4, 10, plank2Block, plank2Meta);
		}
		for (int i28 = 1; i28 <= 3; i28++) {
			setBlockAndMetadata(world, -3, i28, 3, plank2Block, plank2Meta);
			setBlockAndMetadata(world, 3, i28, 3, plank2Block, plank2Meta);
		}
		for (int i27 = -2; i27 <= 2; i27++) {
			setBlockAndMetadata(world, i27, 3, 3, plank2SlabBlock, plank2SlabMeta | 0x8);
		}
		for (int i26 = 4; i26 <= 9; i26++) {
			setBlockAndMetadata(world, -3, 3, i26, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, 3, 3, i26, plank2SlabBlock, plank2SlabMeta | 0x8);
		}
		...
		for (i24 = 4; i24 <= 9; i24++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, -4, i36, i24, plank2Block, plank2Meta);
				setBlockAndMetadata(world, 4, i36, i24, plank2Block, plank2Meta);
			}
		}
		setAir(world, -4, 1, 6);
		...
		for (i24 = -8; i24 <= -3; i24++) {
			for (int i36 = 4; i36 <= 8; i36++) {
				if (i36 != 8 || i24 != -8) {
					...
					setBlockAndMetadata(world, i36, 0, i24, floorBlock, floorMeta);
					if (i36 < 7 || i24 > -7) {
						setBlockAndMetadata(world, i36, 4, i24, plank2Block, plank2Meta);
					}
				}
			}
		}
		for (int i23 = 4; i23 <= 7; i23++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, i23, i36, -2, plank2Block, plank2Meta);
				setBlockAndMetadata(world, i23, i36, -8, plank2Block, plank2Meta);
			}
			setBlockAndMetadata(world, i23, 3, -7, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, i23, 3, -3, plank2SlabBlock, plank2SlabMeta | 0x8);
		}
		for (int i22 = -7; i22 <= -3; i22++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, 8, i36, i22, plank2Block, plank2Meta);
			}
		}
		...
		for (int i20 = -7; i20 <= -4; i20++) {
			for (int i36 = -4; i36 >= -7; i36--) {
				setBlockAndMetadata(world, i36, 0, i20, floorBlock, floorMeta);
				for (int i37 = 1; i37 <= 3; i37++) {
					setAir(world, i36, i37, i20);
				}
				setBlockAndMetadata(world, i36, 4, i20, plank2Block, plank2Meta);
			}
		}
		for (int i19 = -4; i19 >= -7; i19--) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, i19, i36, -8, plank2Block, plank2Meta);
				setBlockAndMetadata(world, i19, i36, -3, plank2Block, plank2Meta);
			}
			setBlockAndMetadata(world, i19, 3, -7, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, i19, 3, -4, plank2SlabBlock, plank2SlabMeta | 0x8);
		}
		int i18;
		for (i18 = -7; i18 <= -3; i18++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, -8, i36, i18, plank2Block, plank2Meta);
			}
		}
		for (i18 = -7; i18 <= -6; i18++) {
			for (int i36 = -5; i36 >= -6; i36--) {
				setBlockAndMetadata(world, i36, 1, i18, carpetBlock, carpetMeta);
			}
		}
		int i17;
		for (i17 = -5; i17 >= -6; i17--) {
			setBlockAndMetadata(world, i17, 0, -8, floorBlock, floorMeta);
			setBlockAndMetadata(world, i17, 1, -8, Blocks.wooden_slab, 8);
			setBlockAndMetadata(world, i17, 2, -8, Blocks.bookshelf, 0);
			setBlockAndMetadata(world, i17, 1, -9, plank2Block, plank2Meta);
		}
		...
		for (i17 = 5; i17 <= 6; i17++) {
			setBlockAndMetadata(world, i17, 0, 7, floorBlock, floorMeta);
			for (int i36 = 1; i36 <= 3; i36++) {
				setAir(world, i17, i36, 7);
			}
			setBlockAndMetadata(world, i17, 4, 7, plank2Block, plank2Meta);
		}
		for (i17 = 5; i17 <= 7; i17++) {
			setBlockAndMetadata(world, i17, 0, 6, floorBlock, floorMeta);
			for (int i36 = 1; i36 <= 3; i36++) {
				setAir(world, i17, i36, 6);
			}
			setBlockAndMetadata(world, i17, 4, 6, plank2Block, plank2Meta);
		}
		for (i17 = 5; i17 <= 8; i17++) {
			setBlockAndMetadata(world, i17, 0, 5, floorBlock, floorMeta);
			for (int i36 = 1; i36 <= 3; i36++) {
				setAir(world, i17, i36, 5);
			}
			setBlockAndMetadata(world, i17, 4, 5, plank2Block, plank2Meta);
		}
		for (int i16 = 1; i16 <= 3; i16++) {
			setBlockAndMetadata(world, 7, i16, 7, plank2Block, plank2Meta);
			setBlockAndMetadata(world, 8, i16, 6, plank2Block, plank2Meta);
			setBlockAndMetadata(world, 9, i16, 5, plank2Block, plank2Meta);
		}
		...
		for (i15 = 4; i15 >= -1; i15--) {
			for (int i37 = 4; i37 <= 9; i37++) {
				setBlockAndMetadata(world, i37, 0, i15, floorBlock, floorMeta);
				for (int i38 = 1; i38 <= 3; i38++) {
					setAir(world, i37, i38, i15);
				}
				setBlockAndMetadata(world, i37, 4, i15, plank2Block, plank2Meta);
			}
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, 3, i36, i15, plank2Block, plank2Meta);
				setBlockAndMetadata(world, 10, i36, i15, plank2Block, plank2Meta);
			}
			setBlockAndMetadata(world, 4, 3, i15, plank2SlabBlock, plank2SlabMeta | 0x8);
			setBlockAndMetadata(world, 9, 3, i15, plank2SlabBlock, plank2SlabMeta | 0x8);
		}
		for (i15 = 2; i15 >= 0; i15--) {
		...
		for (int i14 = 6; i14 <= 7; i14++) {
			for (int i36 = 2; i36 >= 0; i36--) {
				if (random.nextInt(3) == 0) {
					...
					placePlateWithCertainty(world, random, i14, 2, i36, plateBlock, LOTRFoods.HOBBIT);
				} else {
					placePlate(world, random, i14, 2, i36, plateBlock, LOTRFoods.HOBBIT);
				}
			}
		}
		setBlockAndMetadata(world, 5, 3, 7, plank2SlabBlock, plank2SlabMeta | 0x8);
		setBlockAndMetadata(world, 6, 3, 7, plank2SlabBlock, plank2SlabMeta | 0x8);
		setBlockAndMetadata(world, 7, 3, 6, plank2SlabBlock, plank2SlabMeta | 0x8);
		setBlockAndMetadata(world, 8, 3, 5, plank2SlabBlock, plank2SlabMeta | 0x8);
		for (int i13 = 1; i13 <= 3; i13++) {
			int i36;
			for (i36 = 5; i36 <= 6; i36++) {
				setBlockAndMetadata(world, i36, i13, 8, plank2Block, plank2Meta);
			}
			for (i36 = 8; i36 <= 9; i36++) {
				setBlockAndMetadata(world, i36, i13, -2, plank2Block, plank2Meta);
			}
		}
		setBlockAndMetadata(world, -4, 0, 6, plankBlock, plankMeta);
		int i12;
		for (i12 = 7; i12 >= 3; i12--) {
			for (int i36 = -5; i36 >= -7; i36--) {
				setBlockAndMetadata(world, i36, 0, i12, Blocks.double_stone_slab, 0);
				for (int i37 = 1; i37 <= 3; i37++) {
					setAir(world, i36, i37, i12);
				}
				setBlockAndMetadata(world, i36, 4, i12, plank2Block, plank2Meta);
			}
		}
		for (i12 = 6; i12 >= 3; i12--) {
			for (int i36 = -5; i36 >= -6; i36--) {
				setBlockAndMetadata(world, i36, 0, i12, floorBlock, floorMeta);
			}
		}
		setBlockAndMetadata(world, -5, 1, 8, Blocks.crafting_table, 0);
		setBlockAndMetadata(world, -6, 1, 8, Blocks.crafting_table, 0);
		setBlockAndMetadata(world, -7, 1, 8, tableBlock, 0);
		for (int i11 = -7; i11 <= -5; i11++) {
			setAir(world, i11, 2, 8);
			setBlockAndMetadata(world, i11, 2, 9, plank2Block, plank2Meta);
			setBlockAndMetadata(world, i11, 3, 8, Blocks.double_stone_slab, 0);
		}
		...
		for (i10 = 6; i10 <= 7; i10++) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, -8, i36, i10, plank2Block, plank2Meta);
			}
		}
		for (i10 = 3; i10 <= 5; i10++) {
			setBlockAndMetadata(world, -8, 0, i10, Blocks.double_stone_slab, 0);
			setAir(world, -8, 2, i10);
			setBlockAndMetadata(world, -9, 2, i10, plank2Block, plank2Meta);
			setBlockAndMetadata(world, -8, 3, i10, Blocks.double_stone_slab, 0);
		}
		...
		for (int i9 = -4; i9 >= -9; i9--) {
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, i9, i36, 2, plank2Block, plank2Meta);
			}
		}
		...
		for (int i8 = -2; i8 <= 1; i8++) {
			for (int i37 = -9; i37 <= -4; i37++) {
				setBlockAndMetadata(world, i37, 0, i8, plankBlock, plankMeta);
				for (int i38 = 1; i38 <= 3; i38++) {
					setAir(world, i37, i38, i8);
				}
				setBlockAndMetadata(world, i37, 4, i8, Blocks.double_stone_slab, 0);
			}
			for (int i36 = 1; i36 <= 3; i36++) {
				setBlockAndMetadata(world, -10, i36, i8, plank2Block, plank2Meta);
			}
		}
		for (int i7 = -9; i7 <= -4; i7++) {
			setBlockAndMetadata(world, i7, 1, -2, Blocks.wooden_slab, 8);
			setBlockAndMetadata(world, i7, 3, -2, Blocks.wooden_slab, 0);
		}
		int i6;
		for (i6 = -2; i6 <= 1; i6++) {
			setBlockAndMetadata(world, -4, 1, i6, Blocks.wooden_slab, 8);
			setBlockAndMetadata(world, -4, 3, i6, Blocks.wooden_slab, 0);
			setBlockAndMetadata(world, -9, 1, i6, Blocks.wooden_slab, 8);
			setBlockAndMetadata(world, -9, 3, i6, Blocks.wooden_slab, 0);
		}
		...
		for (int i5 = -7; i5 <= -6; i5++) {
			placePlateWithCertainty(world, random, i5, 2, -2, plateBlock, LOTRFoods.HOBBIT);
		}
		placeBarrel(world, random, -5, 2, -2, 3, LOTRFoods.HOBBIT_DRINK);
		for (int i4 = 1; i4 <= 3; i4++) {
			setBlockAndMetadata(world, -9, i4, -3, plank2Block, plank2Meta);
			setBlockAndMetadata(world, -4, i4, 3, plank2Block, plank2Meta);
		}
