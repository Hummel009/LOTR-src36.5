						...
						if (fireworkDisplay > 0) {
							...
							if (world.rand.nextInt(50) == 0) {
								...
								for (int l = 0; l < launches; ++l) {
									...
									if (!world.getBlock(i, world.getHeightValue(i, k = MathHelper.floor_double(entityplayer.posZ) + MathHelper.getRandomIntegerInRange(world.rand, -range, range)) - 1, k).isNormalCube()) {
										continue;
									}
									...
									for (int l1 = 0; l1 < fireworks; ++l1) {
										...
										if (!world.getBlock(i1, (j1 = world.getHeightValue(i1, k1 = k - world.rand.nextInt(groupRange) + world.rand.nextInt(groupRange))) - 1, k1).isNormalCube()) {
											continue;
										}
