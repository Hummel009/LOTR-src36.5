...
public class LOTRCommandPledgeCooldown extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length >= 1) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.pledgeCooldown.set", entityplayer.getCommandSenderName(), cd, LOTRLevelData.getHMSTime_Ticks(cd));
			return;
		}
