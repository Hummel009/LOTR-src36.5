	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (args.length >= 1) {
			...
			if (function.equals("clear")) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.conquest.clear", posX, posZ);
				return;
			}
			if (function.equals("rate")) {
				if (args.length >= 2) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.conquest.rateSet", rate);
					return;
				}
				float currentRate = LOTRLevelData.getConquestRate();
				sender.addChatMessage(new ChatComponentTranslation("commands.lotr.conquest.rateGet", new Object[] { Float.valueOf(currentRate) }));
				return;
			}
			if (args.length >= 3 && (function.equals("set") || function.equals("add") || function.equals("radial"))) {
				...
				if (function.equals("set")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.conquest.set", fac.factionName(), Float.valueOf(amount), posX, posZ);
					return;
				}
				if (function.equals("add")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.conquest.add", fac.factionName(), Float.valueOf(amount), posX, posZ);
					return;
				}
				if (function.equals("radial")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.conquest.radial", fac.factionName(), Float.valueOf(amount), posX, posZ);
					return;
				}
			}
		}
