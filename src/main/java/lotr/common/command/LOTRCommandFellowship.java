...
public class LOTRCommandFellowship extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length >= 3 && args[0].equals("create")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.create", playerName, fsName);
			return;
		}
		...
		if (option.equals("disband")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.disband", ownerName, fsName);
			return;
		}
		if (option.equals("rename")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.rename", ownerName, fsName, newName);
			return;
		}
		if (option.equals("icon")) {
			...
			if (iconData.equals("clear")) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.icon", ownerName, fsName, "[none]");
				return;
			}
			...
			if (itemstack != null) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.icon", ownerName, fsName, itemstack.getDisplayName());
				return;
			}
		...
		if (option.equals("pvp") || option.equals("hired-ff")) {
			...
			if (option.equals("pvp")) {
				...
				if (prevent) {
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.pvp.prevent", ownerName, fsName);
					return;
				} else {
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.pvp.allow", ownerName, fsName);
				}
				return;
			}
			...
			if (prevent) {
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.hiredFF.prevent", ownerName, fsName);
				return;
			} else {
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.hiredFF.allow", ownerName, fsName);
			}
			return;
		}
		if (option.equals("map-show")) {
			...
			if (show) {
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.mapShow.on", ownerName, fsName);
				return;
			} else {
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.mapShow.off", ownerName, fsName);
			}
			return;
		}
		if (args.length < 3) {
		...
		if (option.equals("invite")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.invite", ownerName, fsName, playerName);
			return;
		}
		if (option.equals("add")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.add", ownerName, fsName, playerName);
			return;
		}
		if (option.equals("remove")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.remove", ownerName, fsName, playerName);
			return;
		}
		if (option.equals("transfer")) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.transfer", ownerName, fsName, playerName);
			return;
		}
		if (option.equals("op")) {
			if (!fellowship.hasMember(playerID)) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.op", ownerName, fsName, playerName);
			return;
		}
		...
		CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.fellowship.deop", ownerName, fsName, playerName);
	}
