	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (function != null && cooldown >= 0) {
			...
			if (function.equals("max")) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.wpCooldown.setMax", max, LOTRLevelData.getHMSTime_Seconds(max));
				if (updatedMin) {
			...
			if (function.equals("min")) {
				...
				LOTRLevelData.setWaypointCooldown(max, min);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.wpCooldown.setMin", min, LOTRLevelData.getHMSTime_Seconds(min));
				if (updatedMax) {
