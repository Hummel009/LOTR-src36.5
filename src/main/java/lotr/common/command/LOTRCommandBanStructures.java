...
public class LOTRCommandBanStructures extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length == 0) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.banStructures.ban", new Object[0]);
		} else {
			LOTRLevelData.setPlayerBannedForStructures(args[0], true);
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.banStructures.banPlayer", args[0]);
