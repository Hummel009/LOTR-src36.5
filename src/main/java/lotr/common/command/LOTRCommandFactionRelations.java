			...
			if (function.equals("set")) {
				if (args.length >= 4) {
					...
					try {
						...
						CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.facRelations.set", fac1.factionName(), fac2.factionName(), relation.getDisplayName());
						return;
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.facRelations.reset", new Object[0]);
				return;
			}
		}
