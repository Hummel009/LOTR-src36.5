...
public class LOTRCommandAllowStructures extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length == 0) {
			...
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.allowStructures.allow", new Object[0]);
		} else {
			LOTRLevelData.setPlayerBannedForStructures(args[0], false);
			CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.allowStructures.allowPlayer", args[0]);
