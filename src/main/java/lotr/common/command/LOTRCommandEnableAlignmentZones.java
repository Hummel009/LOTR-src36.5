	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length >= 1) {
			...
			if (flag.equals("enable")) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.alignmentZones.enable", new Object[0]);
				return;
			}
			if (flag.equals("disable")) {
				LOTRLevelData.setEnableAlignmentZones(false);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.alignmentZones.disable", new Object[0]);
				return;
			}
		}
