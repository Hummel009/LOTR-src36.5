		...
		if (args.length >= 2) {
			...
			if (args[0].equalsIgnoreCase("unlock")) {
				if (regionName.equalsIgnoreCase("all")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrWaypoints.unlockAll", entityplayer.getCommandSenderName());
					return;
				}
				...
				playerData.unlockFTRegion(region);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrWaypoints.unlock", entityplayer.getCommandSenderName(), region.name());
				return;
			}
			if (args[0].equalsIgnoreCase("lock")) {
				if (regionName.equalsIgnoreCase("all")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrWaypoints.lockAll", entityplayer.getCommandSenderName());
					return;
				}
				LOTRWaypoint.Region region = findRegionByName(regionName);
				if (!playerData.isFTRegionUnlocked(region)) {
				...
				playerData.lockFTRegion(region);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrWaypoints.lock", entityplayer.getCommandSenderName(), region.name());
				return;
			}
		}
