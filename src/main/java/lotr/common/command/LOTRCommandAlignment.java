		...
		if (args.length >= 2) {
			...
			if (args[0].equals("set")) {
				...
				for (LOTRFaction f : factions) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.alignment.set", entityplayer.getCommandSenderName(), f.factionName(), Float.valueOf(alignment));
				}
				return;
			}
			if (args[0].equals("add")) {
				...
				for (LOTRFaction f : factions) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.alignment.add", Float.valueOf(alignment), entityplayer.getCommandSenderName(), f.factionName());
				}
				return;
			}
		}
