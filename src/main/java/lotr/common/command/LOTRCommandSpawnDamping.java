	...
	public void processCommand(ICommandSender sender, String[] args) {
		if (args.length >= 1) {
			...
			if (option.equals("reset")) {
				...
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.spawnDamping.reset", new Object[0]);
				return;
			}
			if (args.length >= 2) {
				String type = args[1];
				...
				if (option.equals("set") && args.length >= 3) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.spawnDamping.set", type, Float.valueOf(damping));
					return;
				}
