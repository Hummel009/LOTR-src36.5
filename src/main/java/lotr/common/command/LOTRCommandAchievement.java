		...
		if (args.length >= 2) {
			...
			if (args[0].equalsIgnoreCase("give")) {
				...
				if (playerData.hasAchievement(ach)) {
					throw new WrongUsageException("commands.lotr.lotrAchievement.give.fail", new Object[] { entityplayer.getCommandSenderName(), ach.getTitle(entityplayer) });
				}
				playerData.addAchievement(ach);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrAchievement.give", entityplayer.getCommandSenderName(), ach.getTitle(entityplayer));
				return;
			}
			if (args[0].equalsIgnoreCase("remove")) {
				if (achName.equalsIgnoreCase("all")) {
					...
					CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrAchievement.removeAll", entityplayer.getCommandSenderName());
					return;
				}
				LOTRAchievement ach = findAchievementByName(achName);
				if (!playerData.hasAchievement(ach)) {
					throw new WrongUsageException("commands.lotr.lotrAchievement.remove.fail", new Object[] { entityplayer.getCommandSenderName(), ach.getTitle(entityplayer) });
				}
				playerData.removeAchievement(ach);
				CommandBase.func_152373_a(sender, (ICommand) this, "commands.lotr.lotrAchievement.remove", entityplayer.getCommandSenderName(), ach.getTitle(entityplayer));
				return;
			}
		}
