...
public abstract class LOTREnchantment {
	...
	public IChatComponent getEarnMessage(ItemStack itemstack) {
		ChatComponentTranslation msg = new ChatComponentTranslation("lotr.enchant." + enchantName + ".earn", new Object[] { itemstack.getDisplayName() });
	...
	public IChatComponent getEarnMessageWithName(EntityPlayer entityplayer, ItemStack itemstack) {
		ChatComponentTranslation msg = new ChatComponentTranslation("lotr.enchant." + enchantName + ".earnName", new Object[] { entityplayer.getCommandSenderName(), itemstack.getDisplayName() });
		msg.getChatStyle().setColor(EnumChatFormatting.YELLOW);
		return msg;
	}
