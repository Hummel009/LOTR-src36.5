...
public class LOTRAchievement {
	...
	public IChatComponent getAchievementChatComponent(EntityPlayer entityplayer) {
		ChatComponentTranslation component = new ChatComponentTranslation(getUntranslatedTitle(entityplayer), new Object[0]).createCopy();
	...
	public void broadcastEarning(EntityPlayer entityplayer) {
		...
		ChatComponentTranslation dimName = new ChatComponentTranslation(getDimension().getUntranslatedDimensionName(), new Object[0]);
