...
@Mod(modid = "lotr", name = "The Lord of the Rings Mod", version = "Update v36.6 for Minecraft 1.7.10", dependencies = "required-after:Forge@[10.13.4.1558,);before:Botania;before:DragonAPI;before:TwilightForest", guiFactory = "lotr.client.gui.config.LOTRGuiFactory")
public class LOTRMod {
	...
	public void onMissingMappings(FMLMissingMappingsEvent event) {
		...
		for (MissingMapping mapping : mappingsLOTR) {
			Item item;
			Block block;
			String newName;
