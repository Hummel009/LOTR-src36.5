...
extends LOTRGuiMenuBase {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        for (int index = min; index <= max; ++index) {
            ...
            if (title != null) {
                this.displayedTitleInfo.put(title, (Pair<Boolean, Pair<Integer, Integer>>)Pair.of(mouseOver, Pair.of(titleX, titleY)));
            }
        ...
        if (this.selectedTitle != null) {
            ...
            for (EnumChatFormatting code : colorCodes) {
                ...
                GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
                this.displayedColorBoxes.put(code, (Pair<Integer, Integer>)Pair.of(colorX, colorY));
