...
public abstract class LOTRWorldGenHobbitStructure extends LOTRWorldGenStructureBase2 {
  ...
  protected void setupRandomBlocks(Random random) {
    this.isWealthy = makeWealthy(random);
  ...
  protected void spawnHobbitCouple(World world, int i, int j, int k, int homeRange) {
    ...
    spawnNPCAndSetHome((EntityCreature)hobbitMale, world, i, j, k, homeRange);
    ...
    spawnNPCAndSetHome((EntityCreature)hobbitFemale, world, i, j, k, homeRange);
