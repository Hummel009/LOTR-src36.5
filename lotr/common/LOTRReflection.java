...
public class LOTRReflection {
    ...
    public static void setWorldInfo(World world, WorldInfo newWorldInfo) {
        try {
            ObfuscationReflectionHelper.setPrivateValue(World.class, world, newWorldInfo, (String[])new String[]{"worldInfo", "field_72986_A"});
        }
        catch (Exception e) {
    ...
    public static AnimalChest getHorseInv(EntityHorse horse) {
        try {
            return (AnimalChest)ObfuscationReflectionHelper.getPrivateValue(EntityHorse.class, horse, (String[])new String[]{"horseChest", "field_110296_bG"});
        }
        catch (Exception e) {
            LOTRReflection.logFailure(e);
            return null;
    ...
    public static Block getStemFruitBlock(BlockStem block) {
        try {
            return (Block)ObfuscationReflectionHelper.getPrivateValue(BlockStem.class, block, (String[])new String[]{"field_149877_a"});
        }
        catch (Exception e) {
            LOTRReflection.logFailure(e);
            return null;
    ...
    public static boolean isBadEffect(Potion potion) {
        try {
            return (Boolean)ObfuscationReflectionHelper.getPrivateValue(Potion.class, potion, (String[])new String[]{"isBadEffect", "field_76418_K"});
        }
        catch (Exception e) {
            LOTRReflection.logFailure(e);
            return false;
    ...
    public static void removeCommand(Class commandClass) {
        try {
            ...
            Set commandSet = (Set)ObfuscationReflectionHelper.getPrivateValue(CommandHandler.class, handler, (String[])new String[]{"commandSet", "field_71561_b"});
    ...
    public static boolean isFishHookInGround(EntityFishHook fishHook) {
        try {
            return (Boolean)ObfuscationReflectionHelper.getPrivateValue(EntityFishHook.class, fishHook, (String[])new String[]{"field_146051_au"});
        }
        catch (Exception e) {
            LOTRReflection.logFailure(e);
            return false;
    ...
    public static int getFishHookBobTime(EntityFishHook fishHook) {
        try {
            return (Integer)ObfuscationReflectionHelper.getPrivateValue(EntityFishHook.class, fishHook, (String[])new String[]{"field_146045_ax"});
        }
        catch (Exception e) {
            LOTRReflection.logFailure(e);
            return 0;
